...
namespace TigerSan.NET8.WebApi.Controllers
{
    ...
    public class UserController
    {
        ...
        [NoNeedAuthorize]
        /// <summary>登录</summary>
        public async Task<MyActionResult<UserInfo>> Login(string id, string captcha, string search, string password)
        {
            return await _service.Login(id, captcha, search, password);
        }
        ...
        [Route("Captcha")]
        [NoNeedAuthorize]
        public async Task<MyActionResult<CaptchaData>> GetCaptcha()
        {
            return _service.GetCaptcha();
        }
        #endregion 【Functions】
    }
}
