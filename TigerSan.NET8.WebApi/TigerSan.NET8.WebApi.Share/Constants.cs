namespace TigerSan.NET8.WebApi.Share
{
    public static class Constants
    {
        ...
        /// <summary>标签上报间隔（秒）</summary>
        public readonly static double Tag_Report_Interval_Seconds = 3600;
        /// <summary>MQTT上报间隔（秒）</summary>
        public readonly static double Mqtt_Report_Interval_Seconds = 600;
