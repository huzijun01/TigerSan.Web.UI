...
namespace TigerSan.NET8.WebApi.Services.Models
{
    public class PersonService : IdServiceBase<PersonEntity>, IPersonService
    {
        ...
        public async Task<MyActionResult<PersonFullEntity>> GetLoginFull(string search, bool clearPassword = true)
        {
            ...
            {
                res = MyResults<PersonFullEntity>.Error(LogHelper.Instance.Error(e.GetMessage()));
            }
            ...
            FilterDto? filter = null)
        {
            ...
            {
                return MyResults<List<PersonFullEntity>>.Error(LogHelper.Instance.Error(e.GetMessage()));
            }
        }
        #endregion
        ...
        public override async Task<MyActionResult<PersonEntity>> Add(PersonEntity entity, bool isBeginTransaction = true)
        {
            ...
            try
            {
                ...
                return MyResults<PersonEntity>.Success(null, entity);
            }
            catch (Exception e)
            {
                if (transaction != null) await transaction.RollbackAsync(); // 回滚所有操作
                return MyResults<PersonEntity>.Error(LogHelper.Instance.Error(e.GetMessage()));
            }
        }
        #endregion
        #endregion [增]
