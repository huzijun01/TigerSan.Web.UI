...
namespace TigerSan.NET8.WebApi.Services.Models
{
    public class AdminService : IdNameServiceBase<AdminEntity>, IAdminService
    {
        ...
        public async Task<MyActionResult<AdminEntity>> GetByName(string name, bool clearPassword = true)
        {
            ...
            {
                res = MyResults<AdminEntity>.Error(LogHelper.Instance.Error(e.GetMessage()));
            }
        ...
        public override async Task<MyActionResult<AdminEntity>> Add(AdminEntity entity, bool isBeginTransaction = true)
        {
            ...
            try
            {
                ...
                return MyResults<AdminEntity>.Success(null, entity);
            }
            catch (Exception e)
            {
                if (transaction != null) await transaction.RollbackAsync(); // 回滚所有操作
                return MyResults<AdminEntity>.Error(LogHelper.Instance.Error(e.GetMessage()));
            }
        }
        #endregion
        #endregion [增]
