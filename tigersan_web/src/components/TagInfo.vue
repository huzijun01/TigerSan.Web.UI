<template>
    <div class="tag-info-panel">
        ...
        <KeyValue :isAutoHidden="true" :prop-name="Texts.Asset.value" :prop-value="Tag?.assetId" />
        <KeyValue :isAutoHidden="true" :prop-name="Texts.FallDetect.value" :prop-value="IsFall.ToString(Tag?.isFall)" />
...
import { DialogHelper, loading, KeyValue, Texts, ObjectHelper, IsEnable, IsFall } from '@/0_tigersan_ui/tigerui'
