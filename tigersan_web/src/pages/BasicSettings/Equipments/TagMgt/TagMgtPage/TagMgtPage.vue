            ...
            <div class="top-panel flex-between">
                ...
                <div class="button-panel">
                    ...
                    <div class="row-panel">
                        ...
                        <button :disabled="!form.IsAllowBinding.value" @click="form.Binding">
                            {{ Texts.Binding.value }}</button>
                        <button :disabled="!IsOnlySelected" @click="form.Repair">{{ Texts.Repair.value }}</button>
                    </div>
                </div>
            </div>
