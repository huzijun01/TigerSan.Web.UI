<template>
    <PageCard>
        <div class="table-page">
            ...
            <!-- 表格: -->
            <Table :model="tagTypeMgtTable"></Table>

            <!-- 底部: -->
            <div class="bottom-panel flex-center ">
                <Pagination :model="form.pagination" :selectedRowCount="tagTypeMgtTable.SelectedRowCount.value" />
            </div>
        </div>
    </PageCard>

    <!-- 表单: -->
    <PopForm :model="form.tagTypeMgtForm">
        <FormRow>
...
import form from './TagTypeMgtForm'
...
// 【字段】:
// 表格:
const { IsOnlySelected } = tagTypeMgtTable
