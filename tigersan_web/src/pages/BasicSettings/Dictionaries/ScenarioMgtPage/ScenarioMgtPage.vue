<template>
    <PageCard>
        <div class="table-page">
            ...
            <!-- 表格: -->
            <Table :model="scenarioMgtTable"></Table>

            <!-- 底部: -->
            <div class="bottom-panel flex-center ">
                <Pagination :model="form.pagination" :selectedRowCount="scenarioMgtTable.SelectedRowCount.value" />
            </div>
        </div>
    </PageCard>

    <!-- 表单: -->
    <PopForm :model="form.scenarioMgtForm">
        <FormRow>
...
import form from './ScenarioMgtForm'
...
// 【字段】:
// 表格:
const { IsOnlySelected } = scenarioMgtTable
