<template>
    <PageCard>
        <div class="table-page">
            ...
            <!-- 表格: -->
            <Table :model="siteTypeMgtTable"></Table>

            <!-- 底部: -->
            <div class="bottom-panel flex-center ">
                <Pagination :model="form.pagination" :selectedRowCount="siteTypeMgtTable.SelectedRowCount.value" />
            </div>
        </div>
    </PageCard>

    <!-- 表单: -->
    <PopForm :model="form.siteTypeMgtForm">
        <FormRow>
...
import form from './SiteTypeMgtForm'
...
// 【字段】:
// 表格:
const { IsOnlySelected } = siteTypeMgtTable
