...
export class BatchMgtForm {
    ...
    constructor() {
        ...
        this.searchBatchId.Placeholder.value = Texts.Batch
    ...
    /** 增 */
    readonly Add = async () => {
        this.batchForm.Title.value = TextModel.GetText('Add Batch', '新增批次')
    ...
    /** 改 */
    readonly Edit = async () => {
        this.batchForm.Title.value = TextModel.GetText('Edit Batch', '修改批次')
