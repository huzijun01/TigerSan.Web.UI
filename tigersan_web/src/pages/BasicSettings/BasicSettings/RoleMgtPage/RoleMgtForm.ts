...
import { Colors, DialogHelper, Verify, ObjectHelper, DialogMode, DialogState, FormModel, FormConfig, FormItemConfig, BigintHelper, ArrayHelper, PaginationModel, AuthorityHelper, authorityHelper, GetSubmitResult, IdNameModel, MyActionResult, AuthorityModel, loading } from '@/0_tigersan_ui/tigerui'
...
export class RoleMgtForm {
    ...
    constructor() {
        ...
        this.selectDepartment._getItemsAsync = async () => this.selectCompany.Value.value ? await roleHelper.GetBelongDepartmentListAsync(this.selectCompany.Value.value?.id) : []
    ...
    /** 增 */
    readonly Add = () => {
        this.roleForm.Title.value = '新增角色'
    ...
    /** 改 */
    readonly Edit = () => {
        this.roleForm.Title.value = '修改角色'
