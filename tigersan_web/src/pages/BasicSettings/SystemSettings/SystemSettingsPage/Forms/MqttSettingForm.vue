...
import { Form, FormRow, FormItem, DrawerBox, DrawerBoxModel, Switch, Texts, KeyValue, FormItemModel } from '@/0_tigersan_ui/tigerui'
...
itemIsListening.PropTextEN.value = 'IsListening: '
itemIsListening.PropTextCH.value = '是否正在监听：'
