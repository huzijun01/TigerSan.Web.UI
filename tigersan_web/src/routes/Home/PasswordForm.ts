...
import { PasswordModel, FormItemConfig, Verify, FormConfig, FormModel, ObjectHelper, GetSubmitResult, Texts } from '@/0_tigersan_ui/tigerui'
...
export class PasswordForm {
    ...
    /** 改 */
    readonly Edit = async () => {
        this.passwordForm.Title.value = '修改用户信息'
